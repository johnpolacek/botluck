...
const Recent = ({ loadMore }: { loadMore?: boolean }) => {
  ...
  const getRecent = async (startAfter?: { _seconds: number; _nanoseconds: number }) => {
    ...
    setRecentPotlucks(recentPotlucks ? [...recentPotlucks].concat(recent) : recent)
  }
  ...
  return (
    <div className="pb-16 text-center">
      ...
      {
        loadMore && recentPotlucks?.at(-1)?.created && (<div><button
          onClick={(e) => {
            e.preventDefault()
